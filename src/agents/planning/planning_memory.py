...
class PlanningExecutor:
    def __init__(self):
        ...
        self.state_checks_enabled = self.executor_config.get('state_checks_enabled', True)
        self.precondition_checks_enabled = self.executor_config.get('precondition_checks_enabled', True)
        self.snapshot_interval = self.executor_config.get('snapshot_interval', 5.0)
        self.max_deviation_threshold = self.executor_config.get('max_deviation_threshold', 0.3)
