...
TSimulationError = TypeVar("TSimulationError", bound="SimulationError")


class SimulationError(BaseError):
    """
    Root of the Simulation domain error hierarchy.

    Keeps Simulation-specific stable codes while participating in the
